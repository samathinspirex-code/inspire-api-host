"""Apply the Zoom cloud recording retention migration."""
import asyncio
import sys
...
async def apply_migration():
    path = Path(__file__).resolve().parents[1] / "app/modules/lms/sql/zoom_recording_retention.sql"
    ...
    print("Zoom recording retention migration applied successfully")
